    ...
    public void Executar(){
         if(compilado == true) {
            try {
               ...
               String tudo = "cd "+ "\""+ local+ "\""+ "&& echo @echo off >"+ "\""+local+"\\ExecutarGol.bat\""  +" &&  echo @ chcp 65001  ^> nul >>" + "\""+local+"\\ExecutarGol.bat\"" +"&& echo @ title Executando >>" + "\""+local+"\\ExecutarGol.bat\"" + " && echo " +InicioParticao+": >>"+ "\""+local+"\\ExecutarGol.bat\"" + "&& echo cd  "+InicioParticao+":\\QuoGol-IDE\\IDE\\portugol-master" + " >> "+ "\""+local+"\\ExecutarGol.bat\""+ " && echo lua53 main2.lua "+"\""+caminho+"\""+" >>"+ "\""+local+"\\ExecutarGol.bat\""+ "&& echo @ pause >>"+ "\""+local+"\\ExecutarGol.bat\""+ "&& echo  @ taskkill /f /im cmd.exe >>"+ "\""+local+"\\ExecutarGol.bat\"" ;         
